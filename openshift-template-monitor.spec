...
%global package_name openshift-template-monitor
%global product_name OpenShift Template Monitor
%global import_path github.com/adambkaplan/openshift-template-monitor

Name:           %{package_name}
Version:        %{version}
Release:        %{release}%{?dist}
Summary:        Provides standard metrics and alerting around the end-user template lifecycle.
License:        ASL 2.0
...
%description
Provides standard metrics and alerting around the end-user template lifecycle.
...
%changelog
* Mon Apr 10 2018 Adam Kaplan <adam.kaplan@redhat.com> 0.0.1
- Initial release of monitoring app.
